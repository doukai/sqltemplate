...
public class Organization extends Record<Organization> {
    ...
    public User addUser(User user) {
        return addOne(User.class, user);
    }

    public List<User> addUserList(List<User> userList) {
        return addMany(User.class, userList.toArray(new User[]{}));
    }

    public User removeUser(User user) {
        return removeOne(User.class, user);
    }

    public List<User> removeUserList(List<User> userList) {
        return removeMany(User.class, userList.toArray(new User[]{}));
    }
}
