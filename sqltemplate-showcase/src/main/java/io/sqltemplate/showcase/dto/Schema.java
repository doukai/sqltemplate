...
public class Schema extends Record<Schema> {
  ...
  public String[] getColumnNames() {
    return new String[]{ "id","query_type_name","mutation_type_name","subscription_type_name","is_deprecated","version","realm_id","create_user_id","create_time","update_user_id","update_time","create_group_id","__typename" };
  }
