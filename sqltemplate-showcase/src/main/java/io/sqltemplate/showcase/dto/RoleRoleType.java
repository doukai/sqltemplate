...
public class RoleRoleType extends Record<RoleRoleType> {
  ...
  private final String tableName = "role_role_type";

  private final String[] keyNames = new String[]{"id"};

  private final String[] columnNames = new String[]{"id", "role_id", "type", "is_deprecated", "version", "realm_id", "create_user_id", "create_time", "update_user_id", "update_time", "create_group_id", "__typename"};
  ...
  @Override
  public RoleRoleType mapToEntity(Map<String, Object> result) {
    RoleRoleType entity = new RoleRoleType();
    ...
    entity.setType(result.get("type") != null ? (String) result.get("type") : null);
