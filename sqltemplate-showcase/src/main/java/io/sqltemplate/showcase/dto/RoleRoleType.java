...
public class RoleRoleType extends Record<RoleRoleType> {
  ...
  public String[] getColumnNames() {
    return new String[]{ "id","role_id","type","is_deprecated","version","realm_id","create_user_id","create_time","update_user_id","update_time","create_group_id","__typename" };
  }
